...
var programma = [
	...
	{
		class: 'ΗΥ-484',
		name: 'Δυναμική Πολύπλοκων Δικτύων',
		teacher: 'ΤΟΛΛΗΣ',
		monday: '4-6 Α.125',
		tuesday: '',
		wednesday: '4-6 Α.125',
	...
	{
		class: 'ΗΥ-539',
		name: 'Προχωρημένα Θέματα σε Ασύρματα Δίκτυα και Κινητά Υπολογιστικά Συστήματα',
		teacher: 'ΠΑΠΑΔΟΠΟΥΛΗ',
		monday: '6-8 Η.208',
		tuesday: '',
		wednesday: '6-8 Η.208',
	...
	{
		class: 'ΗΥ-561',
		name: 'Διαχείριση Δεδομένων στον Παγκόσμιο Ιστό',
		teacher: 'ΤΖΙΤΖΙΚΑΣ',
		monday: '',
		tuesday: '2-4 Α.125',
		wednesday: '',
